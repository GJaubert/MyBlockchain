...
public:
    ...
    constexpr explicit base_blob(const std::vector<unsigned char>& vch)
    {
...
public:
    ...
    constexpr explicit uint160(const std::vector<unsigned char>& vch) : base_blob<160>(vch) {}
};
...
public:
    ...
    constexpr explicit uint256(const std::vector<unsigned char>& vch) : base_blob<256>(vch) {}
